...
function Order() {
    ...
    <div className="row">
      <div className="col-md-4 col-sm-4 col-xs-6">
        <div className="btn-group btn-groupese">
          <Link className="btn btnes exports" to="#">  All Order </Link>
        </div>
      </div>
        ...
        <div className="row">
          {/* <div className="col-md-4 col-sm-4 col-xs-12">
            <div className="btne-group">
              <p>Bulk Action (For Category Change)</p>
            </div>
          </div>
 ...
 <div className="pt-3 row pl-0">
    ...
    <AllOrderstable   sendDataToParent={handleChildData}  dataFromParent={none}/> 
    </div>

                ...
                <form onSubmit={handleUpload} encType="multipart/form-data">
                  <div className="row">
                    ...
                    {[...Array(6)].map((_, index) => (
                      <div className="col-md-6  mob-left-right col-xs-12" >
                        <div className="row">
                          <div className="col-md-3 pd-top mobile-hids">
                            <label htmlFor="contact_no">
                              Image Uplode {index + 1} <span className="text-danger">*</span>{" "}
                            </label>
                          </div>
                          <div className="col-md-6 mob-left-right col-xs-12">
                            <div className="form-group">
                          ...
                          <div className={`col-md-3 mob-left-right col-xs-12 ${leaddata?.images[index]?.image_name ? '' : 'd-none'}`}>
                    ...
                    <div className="col-sm-6 row mob-left-right col-xs-12">
                      <button type="button" className="btn btn-primary button-57" onClick={handleAddMore}>Click For Add Price With Weight And Discout Price</button>
                    </div>

                    {inputs.map((input, index) => (
                      <div className="col-sm-6 row mob-left-right col-xs-12" key={index}>
                        <div className="row">

                          <div className="col-md-3 pd-top mobile-hids">
                            <label htmlFor={`weight${index}`}>Weight/Price/Discount <span className="text-danger">*</span></label>
                          </div>
                          <div className="col-md-8 mob-left-right col-xs-12">
                            <div className="row">
                        ...
                        <div className="col-md-8 mob-left-right col-xs-12">
                          <div className="form-group">
                           ...
                           onChange={(content) => {
                            setleaddata({
                                ...leaddata,
                                ProductOverviewDiscription: content,
                            });
                        }}
                           name="ProductOverviewDiscription" theme="snow" value={leaddata?.ProductOverviewDiscription} /> */}
                    ...
                    <div className="col-md-12  mob-left-right col-xs-12">
                      <div className="row">
                        ...
                        <div className="col-md-8 mob-left-right col-xs-12">
                          <div className="form-group">
                            {/* <ReactQuill name="SupplimentFacts"
                              modules={modules}
                              value={leaddata?.SupplimentFacts}
                              onChange={(content) => {
                                setleaddata({
                                  ...leaddata,
                                  SupplimentFacts: content,
                                });
                              }}

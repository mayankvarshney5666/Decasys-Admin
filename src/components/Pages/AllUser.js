...
export const AllUser = ({ sendDataToParent, dataFromParent }) => {
  ...
  const getAllProduct = async () => {
    try {
      ...
      // Filtering out the data where role is not equal to "admin"
      const filteredLeads = response.data.agent.filter((item) => item.role !== 'admin');
